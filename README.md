...
| APP_ASSESS_A_CIVIL_CLAIM_NAME                 | Name of `Assess A Civil Claim` Application                                                                                                                           |
| APP_ASSESS_A_CIVIL_CLAIM_URL                  | URL of `Assess A Civil Claim` Application                                                                                                                            |
| APP_ASSESS_A_CIVIL_CLAIM_DETAILS              | Details of `Assess A Civil Claim` Application. The value should be in the form of app_name//app_entra_oid//app_security_group_name//app_security_group_id            |
...
| NOTIFICATION_DELEGATE_FIRM_ACCESS_TEMPLATE_ID | Notification template id for firm access request.                                                                                                                    |
| NOTIFICATION_REVOKE_FIRM_ACCESS_TEMPLATE_ID   | Notification template id for firm access revocation.                                                                                                                 |
