...
/**
 * Unit tests for the CreateUserNotificationService class
 */
@ExtendWith(MockitoExtension.class)
public class CreateUserNotificationServiceTest {
    ...
    public void setup() {
        ...
        createUserNotificationService = new CreateUserNotificationService(notificationService, notificationsProperties);
    }
    ...
    public void testUserIsNotifiedWhenEmailIsIncluded() {
        ...
        ListAppender<ILoggingEvent> listAppender = addListAppenderToLogger(CreateUserNotificationService.class);

        // When
        createUserNotificationService.notifyCreateUser(username, email, password, userId);
    ...
    public void testUserIsNotNotifiedWhenEmailIsNotIncluded() {
        ...
        Mockito.verify(notificationService, Mockito.times(0)).sendMail(any(), any(), any(), any());
        List<ILoggingEvent> infoLogs = LogMonitoring.getLogsByLevel(listAppender, Level.INFO);
