...
public enum Permission {
    ...
    UPDATE_USER_PROFILE_SILAS_STATUS,
    ...
    ASSIGN_INTERNAL_USER_ROLES,
    REMOVE_INTERNAL_USER_ROLES,
    ASSIGN_EXTERNAL_USER_ROLES,
    REMOVE_EXTERNAL_USER_ROLES,
    RESEND_VERIFICATION_EMAIL,
    CAN_REQUEST_DELEGATE_ENABLE_USER,
    CAN_TRACK_DELEGATE_ACTIVATION_REQUESTS,
    CAN_MANAGE_DELEGATE_ENABLE_USER;
