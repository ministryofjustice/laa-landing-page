...
public class UpdateAppDetailsAuditEvent extends AuditEvent {
    ...
    public UpdateAppDetailsAuditEvent(CurrentUserDto currentUserDto, String appName,
    ...
    public String getDescription() {
        return String.format("User '%s' (ID: %s) has updated App \"%s\" details from status '%s' to '%s' and description from '%s' to '%s'",
                userName, userId, appName, previousAppStatus ? "Yes" : "No", updatedAppStatus ? "Yes" : "No", previousAppDescription, updatedAppDescription);
    }
}
