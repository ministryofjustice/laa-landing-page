...
public interface EntraUserRepository extends JpaRepository<EntraUser, UUID> {
    ...
    Page<EntraUser> findByNameOrEmailAndPermissionsAndFirm(@Param("search") String search, @Param("permissions") List<Permission> permissions, @Param("firmId") UUID firmId, Pageable pageable);
