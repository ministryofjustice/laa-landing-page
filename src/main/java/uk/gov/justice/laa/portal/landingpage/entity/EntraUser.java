...
@Table(name = "entra_user", indexes = {
    ...
    @Index(name = "UserEntraIdIdx", columnList = "entra_id"),
...
public class EntraUser extends AuditableEntity {
    ...
    @Column(name = "entra_id", nullable = false, length = 255, unique = true)
    @NotBlank(message = "Entra ID must be provided")
    @Size(min = 1, max = 255, message = "Entra ID must be between 1 and 255 characters")
