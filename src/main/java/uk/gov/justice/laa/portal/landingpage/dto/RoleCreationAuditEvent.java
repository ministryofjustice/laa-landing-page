...
public class RoleCreationAuditEvent extends AuditEvent {
    ...
    public RoleCreationAuditEvent(String roleName, String parentAppName,
                                  String description, String roleIdentifier, String userTypeRestriction,
                                  CurrentUserDto currentUserDto, String userProfileId, String entraOid) {
        this.roleName = roleName;
        this.parentAppName = parentAppName;
        this.description = description;
        this.roleIdentifier = roleIdentifier != null ? roleIdentifier : "N/A";
    ...
    public String getDescription() {
        return String.format(ROLE_CREATION_TEMPLATE, entraOid, userProfileId, parentAppName, roleName, description, roleIdentifier,
                userTypeRestriction);
    }
}
